                ...
                <div class="row" style="margin-top:08%">
                    ...
                    <div class="col-md-4 jumbotron" style="border:0px solid black;background:transparent;padding:1px;" >
                        <div class="row" >
                            ...
                            <div class="col-lg-6 ">
                                    <a href="login" class="btn btn-danger" role="button"style="width:100%; font-family:'Trebuchet MS'; font-size: 1rem;"><span class="barge"><img src="pic1.png" style="height:25px;width:25px;"/></span>I have account</a>
                            </div>                                
                            <div class="col-lg-6 ">
                                <a href="signup" class="btn btn-info" role="button" style="width:100%;font-family:'Trebuchet MS';background:#5bc0de; font-size: 1rem;"><span class="barge"><img src="pic3.png" style="height:20px;width:20px;"/></span>New User</a>
                            </div> 
                       ...
                       <div class="row" style="height:10px;">
                        ...
                        <!--  <div class="">-->
                        <form class="form-container" action="signup" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="input-group" style="padding-bottom:20px;padding-top:5px;">  
                            <span class="input-group-addon" style="border:1px solid #ced4da;border-right:0px;padding-top:3px"><img src="userpng.png" style="height:25px;width:25px;"/></span>                                     
                            <select class="form-control" type="text" name="user_type" placeholder="user type" style="border:1px solid #ced4da;height:5%;border-radius:0;" name="user_type">
                            ...
                            <option value="vendor">Vendor</option>
                               ...
                               <div class="input-group" style="padding-bottom:20px;padding-top:5px;">   
                               <!--  <span class="input-group-addon" style="border:1px solid #ced4da;border-right:0px;padding-top:3px"><img src="key.png" style="height:25px;width:25px;"/></span>         -->                           
                                <input class="form-control" type="file" name="img" hidden="hidden" style="height:5%;border-radius:0;border:0px" >
                            </div>
                            <div >
